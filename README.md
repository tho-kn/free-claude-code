...
[![Tested with Pytest](https://img.shields.io/badge/testing-Pytest-00c0ff.svg?style=for-the-badge)](https://github.com/tho-kn/free-claude-code/actions/workflows/tests.yml)
...
```bash
git clone https://github.com/tho-kn/free-claude-code.git
cd free-claude-code
cp .env.example .env
```
...
uv tool install "free-claude-code[voice_local] @ git+https://github.com/tho-kn/free-claude-code.git"
uv tool install "free-claude-code[voice] @ git+https://github.com/tho-kn/free-claude-code.git"
uv tool install "free-claude-code[voice,voice_local] @ git+https://github.com/tho-kn/free-claude-code.git"
```
...
- Report bugs or suggest features via [Issues](https://github.com/tho-kn/free-claude-code/issues)
